...
global.owner = process.env.OWNER_NUMBER  || '918078438059' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' VAJIRA-MD=WdsAmQSZ#kGLONP3H0f10QSOOrZ1vCK-TNvOpvfegPGji5ptK_q8' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "918078438059" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'WHITE SER' ,
